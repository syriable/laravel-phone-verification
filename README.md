# This is my package laravel-phone-verification
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-phone-verification.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-phone-verification)
...
```bash
php artisan vendor:publish --tag="laravel-phone-verification-views"
```

## Usage

```php
$phoneVerification = new Syriable\PhoneVerification();
echo $phoneVerification->echoPhrase('Hello, Syriable!');
```
