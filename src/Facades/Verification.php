...
/**
 * @method static SendResult send(string $identifier, ?Channel $channel = null, ?string $purpose = null, ?CodeOptions $code = null)
 * @method static SendResult resend(string $identifier, ?Channel $channel = null, ?string $purpose = null, ?CodeOptions $code = null)
 * @method static VerificationResult verify(string $identifier, string $code, ?Channel $channel = null, ?Model $for = null, ?string $purpose = null)
 * @method static VerificationStatus status(string $identifier, ?Channel $channel = null, ?string $purpose = null)
 * @method static bool isVerified(string $identifier, ?Channel $channel = null, ?string $purpose = null)
 * @method static int invalidate(string $identifier, ?Channel $channel = null, ?string $purpose = null)
 ...
 * @method static PendingChannel purpose(string $purpose)
 *
